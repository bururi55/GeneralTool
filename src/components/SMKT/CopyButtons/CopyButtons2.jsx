  ...
  return (
    <div className="copy-buttons-section">
      <div className="copy-button-group">
        ...
        <div class="preserve-formatting" style={{ fontSize: 0 }} id="t25">
        ...
        <div class="preserve-formatting" style={{ fontSize: 0 }} id="t26">
      ...
      <div className="copy-button-group">
        <div class="preserve-formatting" style={{ fontSize: 0 }} id="t28">
      ...
      <div className="copy-button-group">
        ...
        <div class="preserve-formatting" style={{ fontSize: 0 }} id="t32">
      ...
      <div className="copy-button-group">
        ...
        <div class="preserve-formatting" style={{ fontSize: 0 }} id="t35">
      ...
      <div className="copy-button-group">
        ...
        <div class="preserve-formatting" style={{ fontSize: 0 }} id="text47">
      ...
      <div className="copy-button-group">
        <div class="preserve-formatting" style={{ fontSize: 0 }} id="text52">
        ...
        <div class="preserve-formatting" style={{ fontSize: 0 }} id="text53">
