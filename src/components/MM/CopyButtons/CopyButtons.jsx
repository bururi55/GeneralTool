    ...
    <div className="copy-buttons-sectionMM">
      ...
      <div className="copy-button-group-MM">
        ...
        <div style={{ fontSize: 0 }} id="t12">
          Тебе направят 2 платежа в среду-четверг из-за стыка месяцев. ХХХ и
          ХХХ рублей
        </div>
      ...
      <div className="copy-button-group-MM">
        ...
        <div style={{ fontSize: 0 }} id="t15">
          За период 31.03-06.04 у тебя ХХ часов. Ошибок в расчёте нет. Оплату
          направили верно
        </div>
      ...
      <div className="copy-button-group-MM">
        ...
        <div className="preserve-formatting" style={{ fontSize: 0 }} id="text16">
          ...
          <br />Если в течение этого времени кандидат не получит обратную связь, это означает, что он переведён в резервный список. Когда откроют новый набор, то с ним свяжутся
        </div>
